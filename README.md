...
🟢 **v2.10 — stable release. 15 CDN patterns + CDN original resolution + scanning intelligence + brand intelligence.**
...
- `v2.10` — **current stable.** CDN coverage expansion — 15 image CDN patterns (WordPress, Wix, Next.js, Cloudflare, Sanity, ImageKit, DatoCMS, Prismic added). Imgix false positive fix.
